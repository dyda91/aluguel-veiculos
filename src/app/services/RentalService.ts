import { Rental, RentalStatus } from '../../infra/db/sequelize/models/rental';
import { Vehicle } from '../../infra/db/sequelize/models/vehicle';
import { Customer } from '../../infra/db/sequelize/models/customer';
